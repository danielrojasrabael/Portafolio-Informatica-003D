...
as
begin
    OPEN registro FOR SELECT ase.MOTIVO, sol.TIPO, ase.FECHA_PUBLICACION, sol.ESTADO, sol.ID_SOLICITUD, ase.RESPUESTA, ase.FECHA_RESPUESTA, ase.ARCHIVO, ase.TIPO_ASESORIA
    FROM SOLICITUD sol INNER JOIN ASESORIA ase ON ase.ID_SOLICITUD = sol.ID_SOLICITUD
