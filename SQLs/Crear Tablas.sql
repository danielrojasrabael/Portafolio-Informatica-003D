...
--------------------------------------------------------
  ...
  ALTER TABLE "CHECKLIST" MODIFY ("ELEMENTOS" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "VISITA" MODIFY ("UBICACION" NOT NULL ENABLE);
...
INSERT INTO "USUARIO"("CONTRASEÑA", TIPO, ID_COMUNA, DIRECCION) VALUES (1234, 'ADMINISTRADOR', 1, 'Calle Falsa');
